...
<form method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="password" class="form-control" id="confirmPasswordN" name="confirmPassword">
    </div>
    <button type="submit" class="btn btn-primary disabled" id="btnRegister" name="form_register_click">Đăng ký</button>
</form>
<?php } else { ?>
